...
road.place(x=0, y=17)
PATH = "/Games/good_games/Horses"  # os.path.abspath(os.curdir)
# Загрузка фото лошадей
horse01_image = PhotoImage(file=PATH + '\\horse01.png')
horse01 = Label(root, image=horse01_image)

horse02_image = PhotoImage(file=PATH + '\\horse02.png')
horse02 = Label(root, image=horse02_image)

horse03_image = PhotoImage(file=PATH + '\\horse03.png')
horse03 = Label(root, image=horse03_image)

horse04_image = PhotoImage(file=PATH + '\\horse04.png')
